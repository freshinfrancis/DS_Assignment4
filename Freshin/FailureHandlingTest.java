...
public class FailureHandlingTest {
    ...
    private static final int RETRY_LIMIT = 3;           // Number of reconnection attempts
            ...
            new Thread(() -> {
                ...
                while (retries > 0 && !connected) {
                    ...
                    try {
                        ...
                        ContentServer.main(new String[]{SERVER_INFO, FILE_PATH}); // Initial connection attempt
                        connected = true;
                        ...
                        if (retries > 0) {
                            ...
                            try {
                                ...
                                ContentServer.main(new String[]{SERVER_INFO, FILE_PATH}); // Re-attempt connection
